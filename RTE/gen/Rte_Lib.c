/** @file         Rte_Lib.c
  ...
  *
  *
  * Template:     Id: Rte_Lib_c.template 87318 2019-02-01 10:01:02Z DIR9YOK
  */
...
VAR(Rte_ResourceCountRefType, RTE_DATA) Rte_ResourceCount[4];
#define RTE_SYS_STOP_SEC_VAR_CLEARED_32
#include "Rte_MemMap.h" /*lint !e537 permit multiple inclusion */

#define RTE_OSAPPLICATION_CORE0_START_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"
VAR(uint16, RTE_DATA) Rte_ResourceCount_OsApplication_Core0 = 0;
#define RTE_OSAPPLICATION_CORE0_STOP_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"

#define RTE_OSAPPLICATION_CORE1_START_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"
VAR(uint16, RTE_DATA) Rte_ResourceCount_OsApplication_Core1 = 0;
#define RTE_OSAPPLICATION_CORE1_STOP_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"

#define RTE_OSAPPLICATION_CORE2_START_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"
VAR(uint16, RTE_DATA) Rte_ResourceCount_OsApplication_Core2 = 0;
#define RTE_OSAPPLICATION_CORE2_STOP_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"
...
#define RTE_SYS_START_SEC_VAR_CLEARED_32
#include "Rte_MemMap.h" /*lint !e537 permit multiple inclusion */
VAR(Rte_ResourceRefType, RTE_DATA) Rte_Resources[4];
...
Rte_Start(void)                          /* [$Satisfies $SWS 2569] */
{
   ...
   Rte_Resources[OsApplication_Core0] = RTE_REF_FROM_RESOURCE(RTE_RESOURCE_OS_APP_OsApplication_Core0);
   Rte_Resources[OsApplication_Core1] = RTE_REF_FROM_RESOURCE(RTE_RESOURCE_OS_APP_OsApplication_Core1);
   Rte_Resources[OsApplication_Core2] = RTE_REF_FROM_RESOURCE(RTE_RESOURCE_OS_APP_OsApplication_Core2);

   Rte_ResourceCount[OsApplication_Core0] = &Rte_ResourceCount_OsApplication_Core0;
   Rte_ResourceCount[OsApplication_Core1] = &Rte_ResourceCount_OsApplication_Core1;
   Rte_ResourceCount[OsApplication_Core2] = &Rte_ResourceCount_OsApplication_Core2;
