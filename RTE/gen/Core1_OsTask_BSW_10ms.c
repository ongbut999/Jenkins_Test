/** @file     Core1_OsTask_BSW_10ms.c
  *
  * @brief    Task Core1_OsTask_BSW_10ms body
  *
...
#include "Core1_OsTask_BSW_10ms.h"
...
#define RTE_CORE1_OSTASK_BSW_10MS_START_SEC_CODE
#include "Rte_MemMap.h" /*lint !e537 permit multiple inclusion */
TASK(Core1_OsTask_BSW_10ms)
{
   ...
   TerminateTask();
} /* Core1_OsTask_BSW_10ms */
#define RTE_CORE1_OSTASK_BSW_10MS_STOP_SEC_CODE
#include "Rte_MemMap.h" /*lint !e537 permit multiple inclusion */
