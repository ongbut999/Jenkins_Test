/** @file     Core2_OsTask_BSW_10ms.c
  *
  * @brief    Task Core2_OsTask_BSW_10ms body
  *
...
#include "Core2_OsTask_BSW_10ms.h"
...
#define RTE_CORE2_OSTASK_BSW_10MS_START_SEC_CODE
#include "Rte_MemMap.h" /*lint !e537 permit multiple inclusion */
TASK(Core2_OsTask_BSW_10ms)
{
   ...
   TerminateTask();
} /* Core2_OsTask_BSW_10ms */
#define RTE_CORE2_OSTASK_BSW_10MS_STOP_SEC_CODE
#include "Rte_MemMap.h" /*lint !e537 permit multiple inclusion */
