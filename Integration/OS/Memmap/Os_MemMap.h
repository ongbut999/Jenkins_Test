 ...
 *   Project: CliveDevices
 *   Target:  TMSx70TI
 *   Variant: TMS570LS1227
 *   Version: 3.0.3
...
#elif defined (OS_START_SEC_CORE0_CODE_LIB)
  #undef      OS_START_SEC_CORE0_CODE_LIB
  #define DEFAULT_START_SEC_CODE_LIB
#elif defined (OS_STOP_SEC_CORE0_CODE_LIB)
  #undef      OS_STOP_SEC_CORE0_CODE_LIB
  #define DEFAULT_STOP_SEC_CODE_LIB
#elif defined (OS_START_SEC_CORE1_CODE_LIB)
  #undef      OS_START_SEC_CORE1_CODE_LIB
  #define DEFAULT_START_SEC_CODE_LIB
#elif defined (OS_STOP_SEC_CORE1_CODE_LIB)
  #undef      OS_STOP_SEC_CORE1_CODE_LIB
  #define DEFAULT_STOP_SEC_CODE_LIB
/* Callouts */
#elif defined (OS_START_SEC_CALLOUT_CODE)
  #undef      OS_START_SEC_CALLOUT_CODE
