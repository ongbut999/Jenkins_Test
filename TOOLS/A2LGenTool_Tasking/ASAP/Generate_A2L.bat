...
SET PERL5LIB=C:\Strawberry\perl\bin

set HOME=%~dp0
set SW_HOME=%~dp0\..\..\..
set XCP=%SW_HOME%\BSW\src\BSW\Gen\Xcp
set A2L=%SW_HOME%\TOOLS\A2LGenTool_Tasking
...
%PERL_DIR%\perl.exe perl_script\insert_ecu_addresses.pl "D_ENTRY_PLATFROM_temp.map" "Adr_Files" "TASKING_TC27X" "Characteristics.Adr" "Measurements.Adr" > Output_mc.log
