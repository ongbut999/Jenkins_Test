...
#define OS_INIT_SRC_GTMTOM00 (0x403U)
...
#define OS_VEC_Millisecond (2U)
#define OS_CORE_Millisecond (0U)
#define OS_BISR_Millisecond (2U)
#define OS_VEC_GTMTOM0SR0_ISR (3U)
#define OS_CORE_GTMTOM0SR0_ISR (0U)
#define OS_BISR_GTMTOM0SR0_ISR (255U)
...
/* -------- ISR declarations --------- */
#define Millisecond (&Os_const_isrs[0U])
#define OS_IMASK_FOR_Millisecond (0x8002U) /* [$UKS 2009] */
#define OS_CORE_FOR_Millisecond (0U) /* [$UKS 1909] */
DeclareISR(Millisecond)
#define GTMTOM0SR0_ISR (&Os_const_isrs[1U])
#define OS_IMASK_FOR_GTMTOM0SR0_ISR (0x80FFU) /* [$UKS 2009] */
