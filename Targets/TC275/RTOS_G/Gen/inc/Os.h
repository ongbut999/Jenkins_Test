...
#define OS_TARGET_PATCH_VERSION (22U)
...
#define Os_InitializeVectorTable() Os_InitializeInterruptTable(); Os_InitializeTrapTable();
 ...
 extern uint32 OS_MFCR(sint32 reg); /*lint -sem(OS_MFCR,pure) */
...
typedef uint32 uint32_aligned __attribute__ ((aligned (4)));
 ...
 /* [$TargetHT 80] */
 #define CAT1_ISR(x) __inline__ static void Os_inline_##x(void); void x(void) { Os_inline_##x();  } __inline__ static void Os_inline_##x(void) /* [$TgtCore 55] */
#endif /* _lint */
...
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
#ifdef _lint /* Lint does not like attribute on an extern */
  extern FUNC(void, OS_CORE0_CODE) Os_ISRWrapper0(uint32 isr_index, uint32 pcxi);
#else
  extern FUNC(void, OS_CORE0_CODE) Os_ISRWrapper0(uint32 isr_index, uint32 pcxi) __attribute__((interrupt_handler));
#endif /* _lint */
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
