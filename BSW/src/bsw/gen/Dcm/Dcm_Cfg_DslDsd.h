...
#define DCM_CFG_DEFAULT_P2STARMAX_TIME      5000000u       /* P2 star max time of default session in micro seconds */
...
#endif
#define DCM_CFG_NUM_SECURITY_LEVEL          2u               /* Number of security levels configured in SECA service*/
...
#ifdef DcmConf_DcmDslProtocolRx_Diag_Physical_request_Can_Network_CANNODE_0_PduR2Dcm
...
#else
#define DcmConf_DcmDslProtocolRx_Diag_Physical_request_Can_Network_CANNODE_0_PduR2Dcm       0x0      /*Rx PDU ID*/
#endif
#ifdef DcmConf_DcmDslProtocolRx_Diag_Functional_request_Can_Network_CANNODE_0_PduR2Dcm
#error "Symbolic names generated for DcmDslProtocolRxPduId is incorrect as the short names of configured DcmDslProtocolRx in not unique, Run Generate Id and Config Code generation once again."
#else
#define DcmConf_DcmDslProtocolRx_Diag_Functional_request_Can_Network_CANNODE_0_PduR2Dcm       0x1      /*Rx PDU ID*/
#endif

/* Symbolic Name generation for TxConfirmtionPduId */

#ifdef DcmConf_DcmDslProtocolTx_Diag_Physical_response_Can_Network_CANNODE_0_Phys_Dcm2PduR
...
#else
#define DcmConf_DcmDslProtocolTx_Diag_Physical_response_Can_Network_CANNODE_0_Phys_Dcm2PduR         0x0       /*Tx Confirmation PDU ID*/
#endif
...
#define     DCM_CFG_DSL_BUFFER__DCMDSLBUFFER_UDS_TX 255   /* Buffer Size */
#define     DCM_CFG_DSL_BUFFER__DCMDSLBUFFER_UDS_RX 255   /* Buffer Size */
#define     DCM_CFG_DSL_BUFFER__DCMDSLBUFFER_RDPI 4095   /* Buffer Size */
