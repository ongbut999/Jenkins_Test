...
static FUNC(Std_ReturnType,DCM_CODE) Dcm_Prv_CC_Check(P2CONST(Dcm_MsgContextType,AUTOMATIC,DCM_INTERN_DATA) pMsgContext,
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_INTERN_DATA) dataNegRespCode_u8)
{
        ...
        P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_INTERN_DATA) dataNegRespCode_u8)
{
    ...
    *dataNegRespCode_u8 = 0x00;
    ...
    else
    {
        ...
        if (E_OK == Dcm_Prv_CC_Check(pMsgContext,dataNegRespCode_u8))
        {
            retVal_u8 = E_OK;
