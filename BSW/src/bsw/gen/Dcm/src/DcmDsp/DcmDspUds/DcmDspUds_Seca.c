...
static VAR(uint32,AUTOMATIC)                    Dcm_Prv_nrSeedLen_u32;        /* Local variable to store Seed Length */
...
#endif
{
    ...
    Dcm_Prv_nrSeedLen_u32 = Dcm_Prv_ptrSecurityConfig_p->Seed_size_u32;

    /* Fill the seed stored in Request Seed state */
    for(l_idxSeed_qu32 =0; (l_idxSeed_qu32 < Dcm_Prv_nrSeedLen_u32); l_idxSeed_qu32++)
    {
    /* Check if SeedBuffer is valid */
        if(Dcm_Dsp_Seca[Dcm_Prv_idxSecTab_qu8].SeedBuff[l_idxSeed_qu32] != 0x0)
        {
    ...
    /* Fill the seed stored in Request Seed state */
        ...
        pMsgContext->resData[l_idxSeed_qu32 + 0x1u] = Dcm_Dsp_Seca[Dcm_Prv_idxSecTab_qu8].SeedBuff[l_idxSeed_qu32];
        }
    ...
    /* Copy Security Access Data Record into Buffer */
        if( Dcm_Prv_ptrSecurityConfig_p->AccDataRecsize_u32 != 0x00u)
        {
            ...
            Dcm_Prv_ptrSecurityConfig_p->AccDataRecsize_u32);
        }
...
static FUNC(void,DCM_CODE) Dcm_Prv_ReqSecIsCurrentSecurityLevel
                           (P2VAR(Dcm_SrvOpStatusType,AUTOMATIC,DCM_INTERN_DATA) OpStatus,\
                            P2VAR(Dcm_MsgContextType,AUTOMATIC,DCM_INTERN_CONST) pMsgContext)
{
    VAR(uint32,AUTOMATIC)  idxLoopSeed_qu32;    /* Local variable to traverse the loop   */
    /* Fill the response buffer */
    pMsgContext->resData[0] = Dcm_Prv_dataSecAccType_u8;

    /* Fill 0x00 for all bytes of Seed size */
    for(idxLoopSeed_qu32=1;(idxLoopSeed_qu32 <=Dcm_Prv_ptrSecurityConfig_p->Seed_size_u32);idxLoopSeed_qu32++)
    {
                           ...
                           P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_INTERN_DATA) dataNegRespCode_u8)
{
    ...
    if(pMsgContext->reqDataLen != (0x01u + Dcm_Prv_ptrSecurityConfig_p->AccDataRecsize_u32))
    {
                                ...
                                P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_INTERN_DATA) dataNegRespCode_u8)
{
    ...
    else if(pMsgContext->reqDataLen != (Dcm_Prv_ptrSecurityConfig_p->Key_size_u32 + 1u))
    {
        /* Set the negative response as request length is incorrect ($13) */
        *dataNegRespCode_u8 = DCM_E_INCORRECTMESSAGELENGTHORINVALIDFORMAT;
    }
...
#if(DCM_CFG_DSP_SECA_ASP_ENABLED != DCM_CFG_OFF)
static FUNC(void,DCM_CODE) Dcm_Prv_SecaAsyncServerPt(P2CONST(Dcm_MsgContextType,AUTOMATIC,DCM_INTERN_CONST) pMsgContext,\
                                    P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_INTERN_DATA) dataNegRespCode_u8)
{
                           ...
                           P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_INTERN_DATA) dataNegRespCode_u8)
{
    ...
    if(Dcm_Prv_ptrSecurityConfig_p->usePort == USE_ASYNCH_FNC)
    {
        ...
        (Dcm_Prv_ptrSecurityConfig_p->Key_size_u32,&(pMsgContext->reqData[1]),Dcm_DspSecaOpStatus_u8,dataNegRespCode_u8);
    }
#endif
}
/**
...
#endif
{
    ...
    {
        isInfrastructureErrorPresent_b = Dcm_IsInfrastructureErrorPresent_b(Dcm_Prv_dataRetValue_u8);
    }
        ...
        if(Dcm_Prv_ptrSecurityConfig_p->AccDataRecsize_u32!=0x00u)
        {
         ...
         /* MR12 RULE 11.1 VIOLATION: Typecast to function pointer required for implementation -
            ...
            Dcm_Prv_dataRetGetSeed_u8 = (*(Dcm_GetSeed_ptr4)(Dcm_Prv_ptrSecurityConfig_p->Dsp_GetSeed_fp))(
                ...
                Dcm_Prv_nrSeedLen_u32,                          /* Seed size */
                Dcm_Prv_ptrSecurityConfig_p->AccDataRecsize_u32, /* ADR size */
                                       ...
                                       P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_INTERN_DATA) dataNegRespCode_u8)
{
    ...
    *dataNegRespCode_u8 = 0x00;
    ...
    pMsgContext->resDataLen = (uint32)((uint32)Dcm_Prv_nrSeedLen_u32 + 1u);
    ...
    for(l_idxSeed_qu32=0x0; (l_idxSeed_qu32 < Dcm_Prv_nrSeedLen_u32); l_idxSeed_qu32++)
    {
...
static FUNC(void,DCM_CODE) Dcm_Prv_SecaProcessStCmpKeyOk (P2VAR(Dcm_SrvOpStatusType,AUTOMATIC,DCM_INTERN_DATA) OpStatus)
{
    ...
    *OpStatus = DCM_INITIAL;
    ...
    for(l_idxSeed_qu32=0x0; (l_idxSeed_qu32 < Dcm_Dsp_Security[Dcm_Prv_idxSecTab_qu8].Seed_size_u32); l_idxSeed_qu32++)
    {
        /* Store the seed for use in Request KEY state */
        Dcm_Dsp_Seca[Dcm_Prv_idxSecTab_qu8].SeedBuff[l_idxSeed_qu32] = 0x0;
    }
#endif
}
/**
...
FUNC (void,DCM_CODE) Dcm_Dsp_SecaClearSeed (void)
{
    ...
    VAR (uint32,AUTOMATIC) SeedIdx_u32;  /* Local variable to iterate through the seed buffer */
    VAR (uint32,AUTOMATIC) Seedlen_u32;  /* Local variable to iterate through the seed buffer */
