...
typedef struct
{
  ...
  P2FUNC(Std_ReturnType,TYPEDEF,IsRIDRangeAvailFnc_pf) (VAR(uint16,AUTOMATIC),P2VAR(Dcm_NegativeResponseCodeType,AUTOMATIC,DCM_INTERN_DATA));         /* IsRidRangeAvailable function pointer */
  P2FUNC(Std_ReturnType,TYPEDEF,adrCallRoutine_pfct)(VAR(uint8,AUTOMATIC));     /* Call Routine Range function pointer */
  CONSTP2CONST(Dcm_DspRoutineInfoType_tst, TYPEDEF, DCM_INTERN_CONST) adrRoutineInfoRef_cpcst;  /* Extended Configuration for Range Routine Info of Signals and Subfunction */
