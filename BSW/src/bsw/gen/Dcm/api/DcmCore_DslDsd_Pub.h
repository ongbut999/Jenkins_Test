 ...
 * P2CONST(Dcm_ProtocolExtendedInfo_type,TYPEDEF,DCM_INTERN_CONST) roe_info_pcs;   Ptr to ROE info structure \n
 * P2CONST(Dcm_ProtocolExtendedInfo_type,TYPEDEF,DCM_INTERN_CONST) rdpi_info_pcs;        Ptr to RDPI info structure \n
...
/**
 * @ingroup DCMCORE_DSLDSD_AUTOSAR
 * Dcm_Init : Initialization of DCM module
 ...
 */
extern FUNC(Dcm_StatusType,DCM_CODE) Dcm_Prv_ResponseOnOneEvent( CONST(Dcm_MsgType,AUTOMATIC) MsgPtr,
