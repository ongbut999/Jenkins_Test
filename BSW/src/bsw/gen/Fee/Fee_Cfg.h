...
/* Fee Software Version in BASD is Fee / AR40.13.0.0 */
#define FEE_SW_MAJOR_VERSION            13
...
#define FEE_REQUIRED_FREE_SPACE_BEFORE_SOFT_SR        16392uL  /* FEE_REQUIRED_FREE_SPACE_BEFORE_HARD_SR = Min sector size + 1 = 16384 byte + 1) * 1,5 * 1,0 */
#define FEE_REQUIRED_FREE_SPACE_BEFORE_HARD_SR        16392uL  /* FEE_REQUIRED_FREE_SPACE_BEFORE_HARD_SR = Min sector size + 1 = 16384 byte + 1 * 1,0 */
...
#define FEE_PHYS_SEC_END0    0x00003FFFuL
...
#define FEE_PHYS_SEC_START1  0x00004000uL
#define FEE_PHYS_SEC_END1    0x00007FFFuL
...
#define FeeConf_FeeBlockConfiguration_NvMBlockDescriptor_Dem_AllEventsStatusByte                  0
#define FeeConf_FeeBlockConfiguration_NvMBlockDescriptor_DID_SystemFaultRank                      1
#define FeeConf_FeeBlockConfiguration_NvMBlockDescriptor_Dem_EvMemEventMemory2                    2
#define FeeConf_FeeBlockConfiguration_NvMBlockDescriptor_Dem_EvMemEventMemory3                    3
#define FeeConf_FeeBlockConfiguration_NvMBlockDescriptor_Dem_EvMemEventMemory0                    4
#define FeeConf_FeeBlockConfiguration_NvMBlockDescriptor_Dem_EvMemEventMemory1                    5
#define FeeConf_FeeBlockConfiguration_NvMBlockDescriptor_Dem_EvMemEventMemory4                    6
#define FeeConf_FeeBlockConfiguration_NvMBlockDescriptor_Dem_GenericNvData                        7
#define FeeConf_FeeBlockConfiguration_NvMBlockDescriptor_DID_VehicleSpeed                         8
#define FeeConf_FeeBlockConfiguration_NvM_NativeBlock_1024_1                                      9
#define FeeConf_FeeBlockConfiguration_ECUM_CFG_NVM_BLOCK                                          10
#define FeeConf_FeeBlockConfiguration_NvM_NativeBlock_1024_2                                      11
