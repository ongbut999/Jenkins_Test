...
#define FEE_SID_MAINFUNCTION            0x12u    /* Service ID for the FEE main function (unused) */
 #if(FEE_RB_MAINTAIN != FALSE)
    #define FEE_SID_MAINTAIN            0xFBu    /* Service ID for the FEE maintenance function */
 #endif
...
#define FEE_SID_GETMIGRATIONRESULT      0xFFu    /* Service ID for the FEE to read the migration result */
