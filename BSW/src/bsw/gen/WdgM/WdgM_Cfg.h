...
/*TRACE[WDGM126] Include Dem.h*/
#include "Dem.h"
#if (!defined(DEM_AR_RELEASE_MAJOR_VERSION) || (DEM_AR_RELEASE_MAJOR_VERSION != 4))
#error “AUTOSAR major version undefined or mismatched“
#endif
#if (!defined(DEM_AR_RELEASE_MINOR_VERSION) || (DEM_AR_RELEASE_MINOR_VERSION != 2))
#error “AUTOSAR minor version undefined or mismatched“
#endif
...
#define WDGM_NO_OF_CHECKPOINTS                                       ((WdgM_CheckpointIdType)(1))
#define WDGM_NO_OF_DISTINCT_CHECKPOINTS                              ((WdgM_CheckpointIdType)(1))
#define WDGM_MAX_DEADLINE_SUPERVISIONS                               (0)
...
#define WdgMConf_WdgMSupervisedEntity_WdgMSupervisedEntity_Alive_Supervision_Entity1  ((WdgM_SupervisedEntityIdType)(0))

/* Symbolic names for CheckPoint Identifiers */
#define WdgMConf_WdgMCheckpoint_WdgMCheckpoint_Alive_Supervision_Entity1  ((WdgM_CheckpointIdType)(0))


/* Symbolic names for Watchdog instances */
#define WdgMConf_WdgMWatchdog_WdgMWatchdog                           (WdgIfConf_WdgIfDevice_WdgIfDevice)
...
/* No WdgMDeadlineSupervision configured so no timer selection is done*/
#define WDGM_RB_DEADLINE_TIMER_SELECTION WDGM_RB_DEADLINE_TIMER_SELECTION_NONE


#define WDGM_INTERNAL_GRAPH_CONFIGURED  STD_OFF
...
typedef struct
{
    ...
    VAR(Rte_ModeType_WdgMSupervisionCycle,WDGM_VAR_FAST_CLEARED_UNSPECIFIED) SchMWdgMSupervisionCycle;
...
extern CONST(WdgM_CheckpointType, WDGM_CONST_FAST_UNSPECIFIED) WdgM_Checkpoint[1];
extern CONST(WdgM_SupervisedEntityType, WDGM_CONST_FAST_UNSPECIFIED) WdgM_SupervisedEntity[1];
/*No Internal Graph Configured for Logical Supervision....!!! */ 
...
extern CONST(WdgM_AliveSupervisionType, WDGM_CONST_FAST_UNSPECIFIED) WdgM_AliveSupervision[2];
/* No WdgMDeadlineSupervision is configured....!!! */
extern CONST(WdgM_LocalStatusParamsType, WDGM_CONST_FAST_UNSPECIFIED) WdgM_LocalStatusParams[2];
extern CONST(WdgM_TriggerType, WDGM_CONST_FAST_UNSPECIFIED) WdgM_Trigger[2];
extern CONST(WdgM_PrvModeType, WDGM_CONST_FAST_UNSPECIFIED) WdgM_PrvMode[2];
...
extern VAR(WdgM_SupervisedEntityDynType, WDGM_VAR_FAST_CLEARED_UNSPECIFIED) WdgM_SupervisedEntityDyn[1];
