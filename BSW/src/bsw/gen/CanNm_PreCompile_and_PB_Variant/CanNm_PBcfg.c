...
#endif
{
/*CanNmChannelConfig_0*/
    {
        200000,   /* Message cycle time         */
        0, /* Message cycle offset time  */
        2000000,  /* Message timeout time       */
        0,    /* Message reduced time       */
        0,   /* Immediate Nm transmission cycle time         */
        2000000,    /* Network Timeout for NM-Messages       */        
        600000,    /* Timeout for Repeat Message State       */
        0,    /* Timeout for Remote Sleep Indication       */
        5000000,    /* Timeout for bus calm down phase       */
        5,   /* CanIf transmit PDU Id      */
