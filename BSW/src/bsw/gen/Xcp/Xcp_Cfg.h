...
#define XCP_SW_MAJOR_VERSION                      6u
...
#define XCP_DAQRAM_LIMIT                          1024u         /**< Total memory for DAQ configuration for ALL protocol layers */
...
/* Calibration (CAL) */
#define XCP_COMMAND_MODIFY_BITS                   STD_OFF       /**< Switch to En/Disable the command MODIFY_BITS which allows to modify bits in an atomic way*/

/* Page Switching (PAG) */
#define XCP_COMMANDS_GET_PAG_INFO                 STD_OFF       /**< Switch to En/Disable the commands GetPagProcessorInfo, GetPageInfo, GetSegmentInfo */
...
/* Read/Write access */
#define XCP_MEMORY_READ_PROTECTION                STD_OFF       /**< Switch to En/Disable the protection for reading memory (XcpAppl_MemoryReadProtection()) */
#define XCP_MEMORY_WRITE_PROTECTION               STD_OFF       /**< Switch to En/Disable the protection for writing memory (XcpAppl_MemoryWriteProtection()) */
...
#define XCP_ADDRESS_EXTENSION                     STD_OFF        /**< If enabled the address-extension specified in the ASAM-Standard is available and can be used */
...
#define XCP_VERSION_INFO_API                      STD_OFF       /**< Switch to En/Disable the the VersionInfo-Api (Xcp_GetVersionInfo()) */
...
/**************************************************************************/
#define XCP_EVENT_CHANNEL_NUMBER_10MS            XcpConf_XcpEventChannel_Event_10ms_Raster
#define XCP_EVENT_CHANNEL_NUMBER_100MS            XcpConf_XcpEventChannel_Event_100ms_Raster
#define XCP_EVENT_CHANNEL_NUMBER_50MS            XcpConf_XcpEventChannel_Event_50ms_Raster

/***************************    Obsolete   ********************************/
/**************************************************************************/
/*******       Transport Layer Number definition        *******************/
/**************************************************************************/
#define XCP_TRANSPORT_LAYER_ID_XCPTRANSPORTLAYER_0            XcpConf_XcpTransportLayer_XcpTransportLayer_0
...
typedef struct
{
  ...
  Xcp_ErrorCode   (*TLResumeModeData_pfct)    (uint8* DaqRamPtr, const uint8* XcpDaqRamEndPtr, uint8 XcpTransportLayerId);
#endif
  uint8  MaxCto_u8;
  uint16 MaxDto_u16;
