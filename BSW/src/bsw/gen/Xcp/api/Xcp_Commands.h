 ...
 *  \todo     This CMD will also be used for page-freezing-functionality - when this is implemented a switch for this CMD shall also be implemented!
 *  \{
 */
...
/***************************************************************************************************/
/** \defgroup SPECIAL_CMDS Special Commands
 *  \ingroup  CMDS
 */
/***************************************************************************************************/

/**************************************************************************************************/
/** \defgroup CMD_0XC0 command 0xC0 Handling
 *  \ingroup  SPECIAL_CMDS
 *  \brief    Handling of 0xC0 commands and its sub-commands
 *  \{
 */
/**************************************************************************************************/

#define XCP_CMD_0XC0_AVAILABLE (((XCP_ASAM_MAJOR_VERSION <= 1u) && (XCP_ASAM_MINOR_VERSION <= 3u))  ? STD_OFF : STD_ON)

#define XCP_CMD_0XC0_MIN_LENGTH                          2u


/**************************************************************************************************/
/** \defgroup CMD_GET_VERSION GET_VERSION
 *  \ingroup  STD_CMDS
 *  \brief    This command returns detailed information about the implemented protocol layer version
 *            of the XCP slave and the transport layer currently in use.
 *  \sa       Xcp_SubCmdGetVersion
 *  \{
 */
#define XCP_SUBCMD_0XC0_GET_VERSION_AVAILABLE            (XCP_CMD_0XC0_AVAILABLE)
#define XCP_SUBCMD_GET_VERSION_ID                        0x00
#define XCP_SUBCMD_GET_VERSION_LENGTH                    2u
#define XCP_SUBRES_GET_VERSION_LENGTH                    6u


/** \brief GET_VERSION sub-command structure */
typedef struct
{
  uint8  CommandCode_u8;                              /**< 0xC0 */
  uint8  SubCommandCode_u8;                           /**< Subcommand : 0x00 */
}Xcp_SubCmdGetVersion_t;


/** \brief GET_VERSION response structure */
typedef struct {
  uint8  PacketId_u8;                                 /**< 0xFF */
  uint8  Reserved_u8;                                 /**< Reserved */
  uint8  XcpMajorProtocolLayerVersion_u8;             /**< Major version of protocol layer */
  uint8  XcpMinorProtocolLayerVersion_u8;             /**< Minor version of protocol layer */
  uint8  XcpMajorTransportLayerVersion_u8;            /**< Major version of currently active transport layer */
  uint8  XcpMinorTransportLayerVersion_u8;            /**< Minor version of currently active transport layer */
}Xcp_SubResGetVersion_t;


/** \} */

/* Sub-command SET_DAQ_PACKED_MODE that is currently not implemented */
#define XCP_SUBCMD_0XC0_SET_DAQ_PACKED_MODE_AVAILABLE            (STD_OFF)
#define XCP_SUBCMD_SET_DAQ_PACKED_MODE_ID                        0x01

/* Sub-command GET_DAQ_PACKED_MODE that is currently not implemented */
#define XCP_SUBCMD_0XC0_GET_DAQ_PACKED_MODE_AVAILABLE            (STD_OFF)
#define XCP_SUBCMD_GET_DAQ_PACKED_MODE_ID                        0x02

/* Sub-command ASAM_POD that is currently not implemented */
#define XCP_SUBCMD_0XC0_ASAM_POD_AVAILABLE                       (STD_OFF)
#define XCP_SUBCMD_ASAM_POD_ID                                   0xFD
