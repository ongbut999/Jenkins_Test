...
* Defines/Macros
***************************************************************************************************/
#define XCP_ETH_PACKET_HEADER_LEN   4u            /**< XCP Ethernet Header length */
...
***************************************************************************************************/
extern Std_ReturnType Xcp_EthTransmit(const PduInfoType* XcpPacketPtr, uint8 XcpTransportLayerId, Xcp_PduIdType XcpTxPduId);
...
\return     -
***************************************************************************************************/
extern void Xcp_EthMainFunctionTx(void);
...
\return     -
***************************************************************************************************/
extern void Xcp_EthInit(uint8 XcpTransportLayerId, uint8 XcpInitStatus);
...
\return     -
***************************************************************************************************/
extern void Xcp_EthConnect(uint8 XcpTransportLayerId);
...
***************************************************************************************************/
extern Std_ReturnType Xcp_EthDisconnect(uint8 XcpTransportLayerId);
...
\return     -
***************************************************************************************************/
extern void Xcp_EthTransportLayerCmd(const PduInfoType* XcpCmdPacketPtr, PduInfoType* XcpResPacketPtr, uint8 XcpTransportLayerId);
...
\return     XcpTxPduId
***************************************************************************************************/
extern Xcp_PduIdType Xcp_EthGetTxPduId(uint8 XcpPacketId, uint16 XcpEventChannelNumber, uint8 XcpTransportLayerId);
...
***************************************************************************************************/
extern Xcp_ErrorCode Xcp_EthResumeModeData(uint8* DaqRamPtr, const uint8* XcpDaqRamEndPtr, uint8 XcpTransportLayerId);
#endif
