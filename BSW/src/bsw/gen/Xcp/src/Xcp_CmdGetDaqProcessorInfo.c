...
# endif
  ...
  /* DAQ_KEY_BYTE - Bit4 and Bit5: Address_Extension Type - ADDRESS_EXTENSION_FREE */
  ResPtr->DaqKeyByte_u8 |= XCP_DAQ_KEY_BYTE_ADDRESS_EXTENSION_FREE;
#else
  /* DAQ_KEY_BYTE - Bit4 and Bit5: Address_Extension Type - ADDRESS_EXTENSION_NOT_ALLOWED */
  ResPtr->DaqKeyByte_u8 |= XCP_DAQ_KEY_BYTE_ADDRESS_EXTENSION_NOT_ALLOWED;
#endif
