...
static void Xcp_InitDaqOdtEntry(uint8 protLayerId)
{
  /* Init Odt Entries - address, (extension,) size */
  ...
  Xcp_MemSet(&XCP_ODTENTRY_ADDRESS(0, protLayerId), 0, (Xcp_NoInit[protLayerId].DaqConfig.OdtEntryCnt_u16 * (XCP_SIZEOF_ODT_ENTRY)));
}
