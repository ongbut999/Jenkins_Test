...
#define CANTP_IF_PDU_ID_00000     CanIfConf_CanIfTxPduCfg_Diag_Physical_response_Can_Network_CANNODE_0

#define CANTP_IF_FC_PDU_ID_00000  0
#define CANTP_IF_FC_PDU_ID_00001  CanIfConf_CanIfTxPduCfg_Diag_Physical_response_Can_Network_CANNODE_0

/* PduR HandleId import */

#define CANTP_PDUR_DEST_ID_00000  PduRConf_PduRDestPdu_Diag_Physical_response_Can_Network_CANNODE_0_Phys_PduR2CanTp

#define CANTP_PDUR_SRC_ID_00000   PduRConf_PduRSrcPdu_Diag_Functional_request_Can_Network_CANNODE_0_CanTp2PduR
#define CANTP_PDUR_SRC_ID_00001   PduRConf_PduRSrcPdu_Diag_Physical_request_Can_Network_CANNODE_0_CanTp2PduR
...
{
    {  0x8,  0x8,  0x0,  0,    0,    1,     0,     CANTP_IF_PDU_ID_00000, CANTP_PDUR_DEST_ID_00000 }
};

static const struct CanTp_RxSduStructType CanTp_RxSdu[2u] =
{
    {  0x4,  0x0,  0,    1,    0,    0,     0,     CANTP_IF_FC_PDU_ID_00000, CANTP_PDUR_SRC_ID_00000  },
    {  0x0,  0x0,  0,    1,    0,    0,     0,     CANTP_IF_FC_PDU_ID_00001, CANTP_PDUR_SRC_ID_00001  }
};
