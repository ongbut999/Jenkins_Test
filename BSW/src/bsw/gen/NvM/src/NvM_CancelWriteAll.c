...
void NvM_CancelWriteAll(void)
{
    ...
    if (NvM_Prv_ErrorDetection_IsNvmInitialized(NVM_SERVICE_ID_CANCEL_WRITE_ALL, NVM_PRV_MULTI_BLOCK))
    {
        ...
        isBlockMaintainanceEnqueued_b = NvM_Prv_Queue_IsMultiEnqueued(NVM_PRV_SERVICE_ID_MAINTAIN_BLOCK);
        isWriteAllEnqueued_b = (NvM_Prv_Queue_IsMultiEnqueued(NVM_SERVICE_ID_WRITE_ALL) ||
