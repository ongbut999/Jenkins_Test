...
#define NVM_SW_MAJOR_VERSION        13               /* SW major version */
...
#define NVM_MAIN_FUNCTION_PERIOD (0.01f)
// TODO NvM: for RTA-BSW Prerelease 19.10.00: Remove NVM_MAIN_FUNCTION_CYCLE_TIME
#define NVM_MAIN_FUNCTION_CYCLE_TIME (NVM_MAIN_FUNCTION_PERIOD)
...
#define NvMConf_NvMBlockDescriptor_NvMBlockDescriptor_DID_SystemFaultRank (3u)
#define NvMConf_NvMBlockDescriptor_NvMBlockDescriptor_DID_VehicleSpeed (4u)
...
#define NvMConf_NvMBlockDescriptor_NvMBlockDescriptor_Dem_GenericNvData (11u)
#define NvMConf_NvMBlockDescriptor_NvM_NativeBlock_1024_1 (12u)
#define NvMConf_NvMBlockDescriptor_NvM_NativeBlock_1024_2 (13u)
...
#define NVM_CFG_NV_BLOCK_LENGTH_NvM_ConfigId (1u)
...
#define NVM_CFG_NV_BLOCK_LENGTH_NvMBlockDescriptor_Dem_AllEventsStatusByte (6u)
#define NVM_CFG_NV_BLOCK_LENGTH_NvMBlockDescriptor_Dem_EvMemEventMemory0 (20u)
#define NVM_CFG_NV_BLOCK_LENGTH_NvMBlockDescriptor_Dem_EvMemEventMemory1 (20u)
#define NVM_CFG_NV_BLOCK_LENGTH_NvMBlockDescriptor_Dem_EvMemEventMemory2 (20u)
#define NVM_CFG_NV_BLOCK_LENGTH_NvMBlockDescriptor_Dem_EvMemEventMemory3 (20u)
#define NVM_CFG_NV_BLOCK_LENGTH_NvMBlockDescriptor_Dem_EvMemEventMemory4 (20u)
#define NVM_CFG_NV_BLOCK_LENGTH_NvMBlockDescriptor_Dem_GenericNvData (16u)
#define NVM_CFG_NV_BLOCK_LENGTH_NvM_NativeBlock_1024_1 (1024u)
#define NVM_CFG_NV_BLOCK_LENGTH_NvM_NativeBlock_1024_2 (1024u)
...
#define NVM_PRV_SIZE_RAM_MIRROR (20u)
...
#define NVM_CFG_LAST_USER_BLOCK     (13u)

// TRACE[BSW_SWS_AR4_0_R2_NVRAMManager_Ext-3159]
// Number of all configured blocks
#define NVM_CFG_NR_BLOCKS           (14u)

// Additional internal helper definitions
#define NVM_PRV_NR_BLOCKS_ADMIN   (14u)
#define NVM_PRV_NR_PERSISTENT_IDS (12u)
