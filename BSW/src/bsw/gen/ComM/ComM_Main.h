...
/* ---------------------------------------------------------------------*/
/*  Name : ComM_MainFunction_ComMChannel_Can_Network_XCP_Channel                                          */
/*  Description : Main function for Bus Type COMM_BUS_TYPE_CAN  channel ComMChannel_Can_Network_XCP_Channel           */
/* ---------------------------------------------------------------------*/

#if ( COMM_ECUC_RB_RTE_IN_USE != STD_ON )
extern FUNC(void,COMM_CODE) ComM_MainFunction_ComMChannel_Can_Network_XCP_Channel(void);
#endif
