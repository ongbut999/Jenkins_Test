...
static CONST(uint8, COMM_CONST) ComM_DirectUsersPerChannel_ComMChannel_Can_Network_XCP_Channel[] = {
...
static CONST(uint8, COMM_CONST) ComM_AllUsersPerChannel_ComMChannel_Can_Network_XCP_Channel[] = {
    ComMConf_ComMUser_ComMUser_Can_Network_XCP_Channel    };
...
{
    /* Main function period is 10 */
    /* Channel : ComMChannel_Can_Network_XCP_Channel */
#if ((COMM_INHIBITION_ENABLED) &&(COMM_PNC_ENABLED != STD_OFF))
    NULL_PTR,
#endif /* ((COMM_INHIBITION_ENABLED) &&(COMM_PNC_ENABLED != STD_OFF))  */
#if (COMM_INHIBITION_ENABLED)
    ComM_DirectUsersPerChannel_ComMChannel_Can_Network_XCP_Channel,
#endif /*#if (COMM_INHIBITION_ENABLED)  */
    ComM_AllUsersPerChannel_ComMChannel_Can_Network_XCP_Channel,
    COMM_BUS_TYPE_CAN,
    NONE,
#if (COMM_PNC_GW_ENABLED != STD_OFF)
    COMM_GATEWAY_TYPE_ACTIVE,
...
static CONST(uint8,COMM_CONST) ComM_DirectChannelsPerUser_ComMUser_Can_Network_XCP_Channel[] = {
...
,
{
    ComM_DirectChannelsPerUser_ComMUser_Can_Network_XCP_Channel,
#if (COMM_PNC_ENABLED != STD_OFF)
    NULL_PTR,
#endif /* #if (COMM_PNC_ENABLED != STD_OFF)  */
    1,
