...
#define         ComMConf_ComMChannel_ComMChannel_Can_Network_Channel       ((NetworkHandleType)0)

#define         ComMConf_ComMChannel_ComMChannel_Can_Network_XCP_Channel       ((NetworkHandleType)1)
...
#define     ComMConf_ComMUser_ComMUser_Can_Network_XCP_Channel        ((ComM_UserHandleType)(1))
