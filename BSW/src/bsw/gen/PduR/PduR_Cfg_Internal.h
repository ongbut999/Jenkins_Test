...
#if !defined(PDUR_STORE_AND_FORWARD)
#define PDUR_STORE_AND_FORWARD   (0) /* Disabled as the Tp gateway Routing with Limited Buffer Support */
#endif /* PDUR_STORE_AND_FORWARD */
