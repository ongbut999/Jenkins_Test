...
extern FUNC( void, PDUR_CODE ) PduR_dCanIfRxIndication( VAR(PduIdType, AUTOMATIC) id,
...
extern FUNC( void, PDUR_CODE ) PduR_dCanIfTxConfirmation( VAR(PduIdType, AUTOMATIC) id );
