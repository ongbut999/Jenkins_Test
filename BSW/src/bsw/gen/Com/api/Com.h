 ...
 *
 * @param in       RxPduId - Id of the reception I-PDU.\n
 * @param out      RxIPduLengthPtr - Memory address to update received PduLength.\n
 *
 * @return         E_OK - Service has been accepted.\n
...
#define COM_START_SEC_CODE
#include "Com_MemMap.h"
extern FUNC(BufReq_ReturnType, COM_CODE) Com_CopyTxData( PduIdType PduId, const PduInfoType* PduInfoPtr, RetryInfoType* RetryInfoPtr, PduLengthType* TxDataCntPtr );
#define COM_STOP_SEC_CODE
#include "Com_MemMap.h"
