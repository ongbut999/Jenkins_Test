...
#define COM_NUM_RX_SIGNALS        13u
#define COM_NUM_TX_SIGNALS        51u
#define COM_NUM_TX_IPDU         4u
#define COM_NUM_RX_IPDU         5u
...
#define COM_NUM_IPDUS_IN_LAST_IPDUGRP 4u
...
extern VAR(uint8,COM_VAR) Com_IpduBuf_MCU_01_Can_Network_CANNODE_0[];
extern VAR(uint8,COM_VAR) Com_IpduBuf_MCU_02_Can_Network_CANNODE_0[];
extern VAR(uint8,COM_VAR) Com_IpduBuf_MCU_03_Can_Network_CANNODE_0[];
extern VAR(uint8,COM_VAR) Com_IpduBuf_MCU_04_Can_Network_CANNODE_0[];
...
extern VAR(uint8,COM_VAR) Com_LocalBuf_HCU_01_Can_Network_CANNODE_0[];
extern VAR(uint8,COM_VAR) Com_LocalBuf_HCU_02_Can_Network_CANNODE_0[];
extern VAR(uint8,COM_VAR) Com_LocalBuf_HCU_03_Can_Network_CANNODE_0[];
extern VAR(uint8,COM_VAR) Com_LocalBuf_HCU_04_Can_Network_CANNODE_0[];
extern VAR(uint8,COM_VAR) Com_LocalBuf_HCU_05_Can_Network_CANNODE_0[];
