...
#define        NmConf_NmChannelConfig_NmChannelConfig_0    0
...
/* No callback functions are configured */


extern FUNC(void, NM_CODE) Nm_RxIndicationCallback(
                                                                CONST(NetworkHandleType, AUTOMATIC)   NetworkHandle
                                                                    );

extern FUNC(void, NM_CODE) Nm_StateChangeIndication(
                                               CONST(NetworkHandleType, AUTOMATIC)  NetworkHandle,
