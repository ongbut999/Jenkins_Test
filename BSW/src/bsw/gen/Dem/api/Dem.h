...
/** @AR @RTE
 *
 * Returns the qualification state of the operation cycle.
 *
 * @param [in]   OperationCycleId   Identification of a configured DemOperationCycle.
 * @param [out]  isQualified        Qualification flag of cycle
...
/** @AR @RTE
 *
 * Sets a operation cycle qualified, so it may be processed along with its leading cycle.
 *
 * @param OperationCycleId    Identification of a configured DemOperationCycle
 *
