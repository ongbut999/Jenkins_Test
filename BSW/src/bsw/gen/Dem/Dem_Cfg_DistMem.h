...
#define DEM_CFG_DISTURBANCE_MEMORY  DEM_CFG_DISTURBANCE_MEMORY_OFF


#define DEM_CFG_DIST_MEM_CALLBACK_ON_DISTURBANCE_ON  STD_ON
#define DEM_CFG_DIST_MEM_CALLBACK_ON_DISTURBANCE_OFF  STD_OFF
#define DEM_CFG_DIST_MEM_CALLBACK_ON_DISTURBANCE   DEM_CFG_DIST_MEM_CALLBACK_ON_DISTURBANCE_OFF
