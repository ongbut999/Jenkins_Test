...
typedef enum
{
    ...
    #endif /* #if ( defined(RBA_FLSRH850P1xC_FLASH) || defined(RBA_FLSV850R1x_FLASH) || defined(RBA_FLSRH850xx_FLASH) ) */
...
#define FEE_START_SEC_VAR_CLEARED_SECURED_32
#include "Fee_MemMap.h"
...
#define FEE_STOP_SEC_VAR_CLEARED_SECURED_32
#include "Fee_MemMap.h"
