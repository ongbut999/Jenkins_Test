                                                  ...
                                                  VAR(uint32, AUTOMATIC) EndAdr_u32)
{
    ...
    #if !( defined(RBA_FLSRH850P1xC_FLASH) || defined(RBA_FLSV850R1x_FLASH) || defined(RBA_FLSRH850xx_FLASH)) /* Local varaibles are used to save computation time. */
        ...
        switch (Fee_RdWrOrder_st.Fee_LLBuildUpCache_en)
        {
            ...
            case FEE_LL_BLD_UP_CACHE_INIT_E:
            {
                   ...
                   (Fee_LLSectorOrder_st[xLogSecIdx_u8].SecState_en == FEE_SECTOR_FULL_E))
                {
                    ...
                    #if !( defined(RBA_FLSRH850P1xC_FLASH) || defined(RBA_FLSV850R1x_FLASH) || defined(RBA_FLSRH850xx_FLASH))
            ...
            case FEE_LL_BLD_UP_CACHE_READ_E:
            {
                ...
                do
                {
                    ...
                    if ((((Fee_BlkHeader_tst*)(&xDataBuf_au32[0]))->Preamble_au8[2] == (uint8)FEE_BLK_HEADER_PREAMBEL_BYTE_2) &&
                        ...
                        /* Fix for Defect 133411 Possible trap when data matches to preamble value */
                        (xRdAdr_u32 <= ((EndAdr_u32 + 1u) - (FEE_PAGES_USED_BY_BLK_HEADER * FEE_PAGE_LEN))))
                    {

                        /* Load the last programmed page for controllers other then R1x, P1x and RH850xx. */
                        #if !( defined(RBA_FLSRH850P1xC_FLASH) || defined(RBA_FLSV850R1x_FLASH) || defined(RBA_FLSRH850xx_FLASH) )
