 ...
 **********************************************************************************************************************
 */
#define BSWM_TOTAL_NO_OF_ACTIONLIST                         19
...
/* BswMCanSMIndication MRP Type Definition 
...
typedef struct {
	...
	BswM_Cfg_MRPCanSMIndicationType_tst dataCanSM_ast[BSWM_NO_OF_MRP_CANSM_INDICATION]; /* CanSM Indication */
